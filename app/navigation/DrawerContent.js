        ...
        >
          <View style={styles.drawerContent}>
            ...
            />}
              {showIncompleteFeature &&false && user?.serialnumber == "1927" && (user?.role == "HMUser" || user?.role == "CUSER") && <ListItem
              key={"item221"}
              title="استعلام عن موظف"
              onPress={() =>
                props.navigation.navigate(routes.SEARCHEMP)
              }
              listStyle={styles.drawerItem}
              textStyle={styles.drawerTextStyle}
              IconRightComponent={
              ...
              title="طباعة"
              onPress={() =>
                props.navigation.navigate(routes.PRINT)
              }
              listStyle={styles.drawerItem}
              textStyle={styles.drawerTextStyle}
              IconRightComponent={
            ...
            {showIncompleteFeature &&true && user?.serialnumber == "1927" && (user?.role == "HMUser" || user?.role == "CUSER") && <ListItem
              ...
              onPress={() =>
                props.navigation.navigate(routes.BUILDINGSPROC)
              }
              listStyle={styles.drawerItem}
              textStyle={styles.drawerTextStyle}
              IconRightComponent={
            ...
            {showIncompleteFeature && employeePermissions.data?.WATER_NOTIFICATIONS==1 && user?.role == "HMUser" && <ListItem
              ...
              onPress={() => props.navigation.navigate(routes.WATERADMIN)}
              listStyle={styles.drawerItem}
              textStyle={styles.drawerTextStyle}
              IconRightComponent={
                <Icon name={'mail'} localIcon={false} size={40} color={"#fff"} />
            ...
            />}
            {showIncompleteFeature && employeePermissions.data?.SEND_NOTIFICATIONS==1 && user?.role == "HMUser" && <ListItem
            //  
              key={"item031"}
              title="إرسال إشعارات"
              onPress={() => props.navigation.navigate(routes.NOTIFICATIONADMIN)}
              listStyle={styles.drawerItem}
              textStyle={styles.drawerTextStyle}
              IconRightComponent={
                <Icon name={'bell'} localIcon={false} size={40} color={"#fff"} />
              }
            />}
            ...
            {false && (user?.role == "HMUser") && <ListItem
              key={"item32"}
              title="قسيمة الراتب"
              onPress={() => props.navigation.navigate(routes.SALARY)}
              listStyle={styles.drawerItem}
              textStyle={styles.drawerTextStyle}
              IconRightComponent={
                <Icon name={'cash-100'} localIcon={false} size={40} color={"#fff"} />
              }
            />}
            {(user?.role == "CUSER") && showIncompleteFeature && user?.serialnumber == "1927" && <ListItem
              key={"item33"}
              title="قيد مكافأة مالية"
              //onPress={() => props.navigation.navigate(routes.SALARY)}
              listStyle={styles.drawerItem}
              textStyle={styles.drawerTextStyle}
              IconRightComponent={
          ...
          {user?.role != "Anonymous" && <ListItem
            ...
            {user?.role != "Anonymous" && false && <ListItem
              key={"item16"}
              title="المستحقّات"
              onPress={() => props.navigation.navigate(routes.USERTAX)}
              listStyle={styles.drawerItem}
              textStyle={styles.drawerTextStyle}
              IconRightComponent={
                <Icon name={'credit-card'} localIcon={false} size={30} color={"#fff"} />
              }
            />}
