...
function HomeScreen({ navigation }) {
  ...
  const getHaberler = async () => {
    ...
    setHaberler({ loading: false, data: null });
    const staticdata=[
  ...
  const getDuyurular = async () => {
    ...
    const result = await contentApi.getDuyurularNew();
     ...
     />
        ...
        <View style={styles.content}>
         ...
         // homeContent.loading && !homeContent.data?.haberler && (  <HaberSkeleton /> )
          ...
          {  haberler?.data && (
            <Carousel
              ...
              items={haberler.data.map((haber) => {
                let newsDate =
                  haber.dateCreated.split(" ")[0].split("/")[2] +
                  "-" +
                  haber.dateCreated.split(" ")[0].split("/")[1] +
                  "-" +
                  (haber.dateCreated.split(" ")[0].split("/")[0].length === 1
                    ? "0" + haber.dateCreated.split(" ")[0].split("/")[0]
                    : haber.dateCreated.split(" ")[0].split("/")[0]) +
                  "T" +
                  haber.dateCreated.split(" ")[1] +
                  ".000+03:00";
          ...
          {services.loading && !services.data && <Service />}
          {services.data && (
            <>                         
          ...
          {duyurular.data && (
            ...
            {true&&<View style={styles.coverAlone}>
