    ...
    <>
      ...
      {user && (  
         ...
         renderItem={({ item }) => (
          ...
          waterditribution={waterPipe?waterPipe:"-"}
          mntxt={"تمّت البرمجة في قسم البرمجة وتطوير النّظم- دائرة تكنولوجيا المعلومات- بلدية الخليل بالتعاون مع بلدية باغجيلار -2023"}
          settings={settings}
         // onPress={() => {
              //getUnit(item);
