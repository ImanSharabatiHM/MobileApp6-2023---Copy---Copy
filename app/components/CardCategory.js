  ...
  return (
    <>
      {<TouchableWithoutFeedback onPress={onPress} >
        <View style={{ flex: 1, flexDirection: 'column', margin: 5, marginRight: 5, backgroundColor: visible==-1?colors.white:visible==1?colors.whatsapp:colors.danger, padding: 5, marginBottom: 7 }}>
          <Image style={styles.imageThumbnail}
            source={
              ...
              imageUrl== "cameraIcon"?require('../assets/icons/passive/cameraIcon.png'):

              
              imageUrl=="electricityIcon"?
              require('../assets/icons/passive/electricityIcon.png'):
              imageUrl=="warningIcon"?
              require('../assets/icons/passive/warningIcon.png'):
